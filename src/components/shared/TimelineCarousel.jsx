          ...
          <div className="md:hidden">
            ...
            >
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="relative h-64">
                    ...
                    />
                    {/* Mobile totoko overlay */}
                    <div className="absolute -bottom-9 -left-4">
                      <div className="text-[80px] font-bold text-white font-grotesk">
                        totoko
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Mobile Content */}
                  <div className="px-6 py-8 text-official-text">
                    <div className="text-sm font-grotesk font-medium tracking-snug mb-4">
                      {timelineData[currentSlide].title}
                    </div>

                    <h2 className="text-[40px] font-grotesk font-bold leading-120 tracking-snug mb-6">
                      {timelineData[currentSlide].heading}
                    </h2>

                    <p className="font-magnetik leading-140 font-medium text-sm">
              ...
              <div className="flex justify-between items-center mt-6 px-6">
                <button
                  onClick={prevSlide}
                  className="w-[52px] h-[52px] bg-white border border-gray-200 flex items-center justify-center hover:bg-gray-50 transition-all duration-300"
                >
                ...
                <div className="text-sm font-grotesk text-official-text leading-10 gap-x-6 flex flex-row items-center justify-center">

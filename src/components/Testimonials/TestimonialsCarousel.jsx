      ...
      <div ref={ref} className="container-max">
        ...
        >
          <h3 className="text-2xl md:text-3xl font-semibold text-gray-900 mb-4">
            Ready to begin? Share your requirement
          </h3>
          <p className="text-lg md:text-xl text-gray-600 mb-8">
            and let expert guidance bring clarity.
          </p>
          
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="bg-green-700 hover:bg-green-800 text-white font-semibold px-8 py-4 rounded-lg transition-colors duration-300 shadow-lg text-lg"
          >
            GET STARTED
          </motion.button>
        </motion.div>
